...
class Transformer_block(nn.Module):
    def __init__(
        self, Transformer_block, num_layers, norm=None, return_intermediate=False
    ):
        super().__init__()
...
class Transformer(nn.Module):
    def __init__(
        ...
        SLPT_Inherent_Layer = Inherent_Layer(
    ...
    def forward(self, src):
        ...
        tgt = self.Transformer_block(
            tgt, src, pos=structure_encoding, query_pos=landmark_query
        )
